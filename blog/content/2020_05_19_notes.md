...
* If you find building a rad weed wacker bike in the most aggressive manner possible objectionable, do not click [here](https://www.youtube.com/watch?v=PA23qLvl79k).

### Tech
* A long time `bash` user, I am now a fledgling `zsh` convert thanks in part to [starship](https://starship.rs/).
* On the Mac, I use [GNU tools](https://www.topbug.net/blog/2013/04/14/install-and-use-gnu-command-line-tools-in-mac-os-x/).
