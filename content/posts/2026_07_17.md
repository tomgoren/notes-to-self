...
[Dr. Natasha Goldowski Renner](https://en.wikipedia.org/wiki/Natasha_Goldowski_Renner) fled the Russian Revolution, helped build French war planes, fled Nazi occupation, worked on the Manhattan project, got penalized by McCarthyism, and taught cybernetics to art students in the Appalachians.

I learned about Dr. Renner and her prescient paper, "High Speed Computing Machines", from [Eliot Inman](https://musicalcircuits.com/2019/10/14/high-speed-computing-for-poets/).
...
However, it is a PDF, and therefore opaque to search engines.

In this article, published **75 years ago**, Dr. Goldowski Renner presents ideas that are incredibly relevant to today.
They span machine learning, automation and job displacement, and other current day ethical quandries.
I was inspired to make the text more accessible, so I used OCR and "AI" and the results are shared below.

There is an absolutist quality to the conclusions of the article that makes it difficult to wholeheartedly agree,
but there is a degree to which we are currently witnessing how the prophecy will play out.
I'm going to keep rooting for the humans either way.

## Legal stuff

* Source:
    * JSTOR Open Collections
    * https://www.jstor.org/stable/community.28034129

_Licensed under Creative Commons Attribution-NonCommercial (CC BY-NC)._
